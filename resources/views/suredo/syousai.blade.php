...
<table  width="100%"class="center"><tr><td>
  ...
  <table width="95%"class="white">
    ...
    <tr><td class="in">{{ $suredo->taitoru }}</td><br></tr> 
    <tr><td class="left">name : </td></tr>
    <tr><td class="in">{{ $suredo->name }}</td><br></tr> 
    <tr><td class="left">honbun : </td></tr>
    <tr><td class="in">{{ $suredo->honbun }}</td></tr> 
    <tr><td class="left"></td></tr>
    <input type="hidden" name="taitoru" value="{{ $suredo->taitoru }}">
    <input type="hidden" name="name" value="{{ $suredo->name }}">
    <input type="hidden" name="bangou" value="{{ $suredo->bangou }}"></td></tr> 
